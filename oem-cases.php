    ...
    <section class="mainContent">
      ...
      <div class="productRow">
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/34/500/10443609473074.jpg
"></div>
          	<p >Dark Diamond PRO 4x12cm RGB USB 3.0
 
 </p>
			<p class="price">358,58 TL

</p>
          	<p class="productContent"><del>429,00 TL
</del> </p>
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div>
			 <img alt="sample" src="https://productimages.hepsiburada.net/s/31/500/10339292446770.jpg
"></div>
			  <p>Corsair CC-9011151-EU SPEC-05 MidTower Watt 80 Plus PSU
</p>
				<p class="price">671,04 TL
</p>
...
"></div>
      ...
      <div class="productRow"> 
		...
		<!-- Each product row contains info of 3 elements -->
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/31/500/10323639533618.jpg

" ></div>
          <p>Aerocool Quartz Revo 600W USB 3.0 Siyah ATX

</p>
				<p class="price">773,04 TL

</p>
			  <p class="productContent"><del>970,00 TL
...
"></div>
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/29/500/10274377400370.jpg

"></div>
          <p>Corsair Obsidian 1000D Super Tower

</p>
				<p class="price">3962,71 TL

</p>
			  <p class="productContent"><del>5092,00 TL
          ...
          <input type="button" name="button" value="Buy" class="buyButton">
		   ...
		   <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/35/500/10474234937394.jpg
