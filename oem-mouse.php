...
"></div>
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/18/1500/9790968004658.jpg"></div>
         <p>Asus WT425 Kablosuz Optik Sessiz Tıklama Özellikli Siyah Mouse</p>
				<p class="price">93,91 TL</p>
			  <p class="productContent"><del>114,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
...
"></div>
          <p>Rampage Shine SMX-R15 10000 DPI RGB Oyuncu Mouse Siyah - Gri</p>
				<p class="price">169,89 TL</p>
			  <p class="productContent"><del>199,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
...
"></div>
          <p>Razer Basilisk Ultimate (TBC) Kablolu/Kablosuz Oyuncu Mouse</p>
				<p class="price">1104,88 TL</p>
			  <p class="productContent"><del>1139,05 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
...
"></div>
          <p>Asus L701-1A-ROG Spatha Oyuncu Mouse</p>
				<p class="price">1041,21 TL</p>
			  <p class="productContent"><del>1512,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
    </section>
