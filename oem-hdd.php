    ...
    <section class="mainContent">
      ...
      <div class="productRow">
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/2/500/9565998972978.jpg
"></div>
          	<p >Seagate Barracuda 1TB 3.5" 7200RPM 64MB </p>
			<p class="price">288,99 TL</p>
          	<p class="productContent"><del>401,00 TL</del> </p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div>
			 <img alt="sample" src="https://img10.joybuy.com/N0/s560x560_jfs/t1/28299/34/6308/150026/5c4bcc4bE063e6c99/293a84b28a627573.jpg.dpg
"></div>
			  <p>WD Blue 1TB 7200RPM Sata 3.0 64Mb 3,5"</p>
				<p class="price">279,00 TL</p>
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/24/1500/10084143005746.jpg

"></div>
         <p>Seagate BarraCuda 2TB 7200RPM 256MB</p>
				<p class="price">470,00 TL</p>
			  <p class="productContent"><del>626,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
      ...
      <div class="productRow"> 
		...
		<!-- Each product row contains info of 3 elements -->
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://mcdn01.gittigidiyor.net/53818/tn50/538188455_tn50_0.jpg

" ></div>
          <p>Seagate 500GB 5900RPM Sata 3.0 <br> 8MB 3.5"</p>
				<p class="price">114,99 TL</p>
			  <p class="productContent"><del>119,78 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton wow flash">
        </article>
		  
		  
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/12/1500/8920605458482.jpg

"></div>
          <p>WD Purple 1TB Intellipower Sata 3.0 64Mb 3,5"</p>
				<p class="price">245,00 TL</p>
			  <p class="productContent"><del>325,90 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/22/1500/9941129068594.jpg

"></div>
          <p>Toshiba P300 High Performance 3.5" Sata 3.0 1TB</p>
				<p class="price">344,35 TL</p>
			  <p class="productContent"><del>386,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
      ...
      <div class="productRow">
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/12/500/8920605655090.jpg

"></div>
          <p>WD Purple 2TB Intellipower Sata 3.0 64Mb 3,5"</p>
				<p class="price">395,00 TL</p>
			  <p class="productContent"><del>576,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/32/500/10356761428018.jpg

"></div>
          <p>Seagate Exos X10 3.5'' 16TB 7200RPM <br>256MB</p>
				<p class="price">5399,00 TL</p>
			  <p class="productContent"><del>5805,38 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/24/500/10084145070130.jpg

"></div>
          <p>Seagate IronWolf Pro 14TB 7200RPM 256MB Cache SATA 6.0GB/s 3.5"</p>
				<p class="price">4199,00 TL</p>
			  <p class="productContent"><del>4515,05 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
    </section>
