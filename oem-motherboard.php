    ...
    <section class="mainContent">
      ...
      <div class="productRow">
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/24/500/10072262672434.jpg
"></div>
          	<p >Gigabyte B450M S2H AMD B450 2133MHz DDR4 Soket AM4 mATX Anakart</p>
			<p class="price">489,00 TL</p>
          	<p class="productContent"><del>543,33 TL</del> </p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div>
			 <img alt="sample" src="https://productimages.hepsiburada.net/s/18/500/9802631315506.jpg
"></div>
			  <p>Gigabyte A320M-S2H AMD A320 3200Mhz(OC) DDR4 Socket AM4 PCI-E 2.0 
</p>
      ...
      <div class="productRow"> 
		...
		<!-- Each product row contains info of 3 elements -->
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/35/500/10474088398898.jpg
...
" ></div>
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://cdn.vatanbilgisayar.com/Upload/PRODUCT/MSI/thumb/TeoriV2-104603_large.jpg
...
"></div>
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/31/1500/10341467422770.jpg
"></div>
          <p>MSI B450-A Pro Max AMD B450 3466MHz DDR4 Soket AM4 ATX Anakart</p>
				<p class="price">853,14 TL</p>
			  <p class="productContent"><del>922,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
      </div>
      ...
      <div class="productRow">
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/31/1500/10290240651314.jpg

"></div>
          <p>MSI B450 Tomahawk Max AMD B450 4133MHz DDR4 Soket AM4 ATX Anakart</p>
				<p class="price">1114,13 TL</p>
			  <p class="productContent"><del>1148,59 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/35/500/10474089742386.jpg

"></div>
          <p>Asus ROG Strix B360-H Gaming 2666MHz DDR4 Soket 1151 ATX <br>Anakart</p>
				<p class="price">884,28 TL</p>
			  <p class="productContent"><del>1172,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/29/1500/10257752653874.jpg

"></div>
          <p>MSI MPG X570 Gaming Edge WiFi AMD X570 1866MHz DDR4 Soket AM4 ATX Anakart</p>
				<p class="price">1793,87 TL</p>
			  <p class="productContent"><del>1939,00 TL</del></p>
          <input type="button" name="button" value="Buy" class="buyButton">
        </article>
		  
		   <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="https://productimages.hepsiburada.net/s/35/1500/10463130091570.jpg
"></div>
