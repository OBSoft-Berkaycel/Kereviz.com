    ...
    <section class="mainContent">
      ...
      <div class="productRow">
        ...
        <article class="productInfo"><!-- Each individual product description -->
          <div><br><br><img alt="sample" src="https://productimages.hepsiburada.net/s/24/550/10091419664434.jpg/format:webp"></div>
...
"></div>
         <p>GameBooster Spirit Wheel Rainbow RGB LED</p>
...
"></div>
          <p><br><br>Audio Technica BP40 Geniş Diyaframlı Dinamik Yayın Mikrofonu
...
"></div>
          <p>GameBooster H03 Dragon King Running RGB LED Titreşimli 7.1 Siyah Oyuncu Kulaklığı</p>
...
"></div>
          <p>Marantz Umpire Usb Mikrofon</p><br><br>
